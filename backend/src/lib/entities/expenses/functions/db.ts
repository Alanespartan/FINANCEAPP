...
* @param {ExpenseType} toSave Expense category object used to overwrite existing entry or create a new one
...
* @param {ExpenseType} toSave Expense sub category object used to overwrite existing entry or create a new one
